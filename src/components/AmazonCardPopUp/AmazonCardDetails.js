                ...
                <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full px-4 md:w-1/2 ">
                            <div class="flex flex-col gap-2">
                                ...
                                {/* <div class="sm:text-2xl text-lg flex flex-wrap gap-2">
                                    <h2 className='font-bold'>Brands:</h2> <span>{cardData?.title}</span>
                                </div>
                        ...
                        <div class="w-full px-4 md:w-1/2 ">
                            <div class="lg:pl-20">
                                <div class="mb-8 ">
                                    <span class="text-lg font-medium text-rose-500 dark:text-rose-200">Title</span>
                                    ...
                                    <div class="max-w-md mb-8 text-gray-700 dark:text-gray-400">
                                        <p className='font-bold'>Price:</p><span>{cardData?.price}</span>
                                    </div>
