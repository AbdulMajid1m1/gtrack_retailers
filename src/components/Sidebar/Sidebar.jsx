      ...
      >
        <div className="h-full px-3 py-2 overflow-y-auto bg-primary">
          ...
          <div
            ...
            onContextMenu={(event) =>
              handleContextMenu(event, '/inventory-items')
            }
          ...
          <div
            className={`main-images-container ${selectedItem === '/pos-module' ? 'selected-item' : ''}`}
            onClick={() => handleItemClick('/pos-module')}
            onContextMenu={(event) =>
              handleContextMenu(event, '/pos-module')
            }
          ...
          >
            <img
              ...
              alt=""
            />
            <p className="sidebar-text">POS Module</p>
          </div>

          <div
            className={`main-images-container ${selectedItem === '/price-checker' ? 'selected-item' : ''}`}
            onClick={() => handleItemClick('/price-checker')}
            onContextMenu={(event) =>
              handleContextMenu(event, '/price-checker')
            }
