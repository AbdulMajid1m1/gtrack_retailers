    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='sm:w-full lg:w-full w-full h-[100vh] overflow-y-auto bg-blue-300 bg-opacity-20 px-0 sm:px-2 sm:py-2'>
          <div className='h-10 w-full bg-primary flex justify-start items-center px-2'>
            ...
            <div className="flex flex-col md:flex-row border-2 border-dashed mt-3">
              ...
              <div className="w-full md:w-1/3 flex flex-col justify-center items-center -mt-6 p-8">
                ...
                {data?.gtinArr?.productImageUrl && (
                  <img src={data.gtinArr.productImageUrl} alt="Product" className="w-1/2 h-32 object-contain" />
...
export default PriceCheckerPortrait