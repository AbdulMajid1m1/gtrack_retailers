...
const PosModule = () => {
  ...
  const handleBlur = async () => {
    ...
    try {
      ...
      data = {
        ...data,
        unitPrice: produectContentData?.unitPrice,
        qty: parseFloat(qty),
      };
  ...
  const toggleFullscreen = () => {
    if (isFullscreen) {
      document.exitFullscreen().catch((error) => {
        console.error(
          `Error exiting full-screen mode: ${error.message} (${error.name})`
        );
      });
    } else {
      document.documentElement.requestFullscreen().catch((error) => {
        console.error(
          `Error entering full-screen mode: ${error.message} (${error.name})`
        );
      });
    }
      ...
      <div className="p-1 bg-slate-100">
        <div className="h-auto w-full">
          <div className="h-14 w-full bg-primary flex justify-start items-center">
            <button
              onClick={() => navigate(-1)}
              className="font-medium rounded-sm p-2 py-1"
            >
              <span>
                <img
                  src={backarrow}
            ...
            <button
              ...
              className="font-medium h-auto w-14 rounded-sm p-2 py-1"
            >
              <FullscreenIcon
                style={{
                  height: "auto",
            ...
            <h3 className="text-white text-1xl font-semibold ml-2">
              ...
              <div className="grid 2xl:grid-cols-1 mt-2 xl:grid-cols-1 lg:grid-cols-1 md:grid-cols-1 grid-cols-1">
                <div className="flex items-center gap-1 px-2 font-semibold">
                  ...
                  <input
                    ...
                    className="h-8 w-[30%] text-center border border-gray-400"
              ...
              <div className="p-2">
                <div className="flex justify-between items-center p-1">
                  ...
                  <input
                    ...
                    disabled
                    style={{ backgroundColor: "#fff", fontSize: "20px", fontWeight: "bold" }}
